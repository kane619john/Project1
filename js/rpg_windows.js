...
Window_Base.prototype.drawActorHp = function(actor, x, y, width) {
    ...
    this.drawText(TextManager.hpA, x, y, 84);
...
Window_Base.prototype.drawActorMp = function(actor, x, y, width) {
    ...
    this.drawText(TextManager.mpA, x, y, 84);
...
Window_Status.prototype.setActor = function(actor) {
    if (this._actor !== actor) {
        this._actor = actor;
     this._actor = null;
    if($gameVariables.value(178)!=0)this._actor = $gameActors.actor($gameVariables.value(178));
        this.refresh();
    }
};
...
Window_MapName.prototype.initialize = function() {
    ...
    var height = this.windowHeight();
    Window_Base.prototype.initialize.call(this, 225, 220, wight, height);
    //地图名
    this.opacity = 0;
...
Window_MapName.prototype.refresh = function() {
    ...
    if ($gameMap.displayName()) {
        ...
        this.drawBackground(0, 0, width, this.lineHeight()+50);
