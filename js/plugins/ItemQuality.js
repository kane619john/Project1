...
RJO.HE.normalcolor = function(item){return RJO.IQ.QualitiesColor[0];}
...
RJO.HE.getItemExtraDescParams2 = function(item,type){
    ...
    var text="<pos=AN text=品质："+RJO.IQ.QualitiesName[item.meta.quality||0]+" size=18 color=normalcolor line=false align=0>";
