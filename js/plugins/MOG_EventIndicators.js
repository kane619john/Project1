	       ...
	       if (l.code === 108) {var comment = l.parameters[0].split(' : ')
		           if (!this._indData.force) {
					   ...
					   if (comment[0].toLowerCase() == "range_indicator"){
						   ...
						   if($gameVariables.value(307)>0)this._indData.rangeD += $gameVariables.value(307)*2;
					   };
					   ...
					   if (comment[0].toLowerCase() == "fontsize_indicator"){
						   this._indData.ref = true;
						   if($gameVariables.value(307)>0){
					       this._indData.fontSize = Number(comment[1])+$gameVariables.value(307);
				           }
						   else this._indData.fontSize = Number(comment[1]);
					   };
					   ...
					   if (comment[0].toLowerCase() == "rotation_indicator"){
						   this._indData.rotation = [false,Number(comment[1])]
					   };
...
EventIndicators.prototype.createText = function() {
	...
	if($gameVariables.value(307)>0)this._text.bitmap.outlineWidth = 2+$gameVariables.value(307)/5
	this.addChild(this._text);
        this._text.textColor = 1;
	this.refreshText();
};
...
EventIndicators.prototype.refreshText = function() {
     ...
     var rota = this.data().rotation[1];
     if(rota == 1)this._text.bitmap.textColor = '#6495ED';
     else if(rota == 2)this._text.bitmap.textColor = '#FF0000';
     else if(rota == 3)this._text.bitmap.textColor = '#FFC125';
     else if(rota == 4)this._text.bitmap.textColor = '#76EE00';
     else if(rota == 5)this._text.bitmap.textColor = '#CAFF70';
     else if(rota == 9)this._text.bitmap.textColor = '#E0FFFF';
     else this._text.bitmap.textColor = '#C2C2C2';
     
     if(text.indexOf('Player')!= -1){
     	text = text.substring(0,text.length-6) + $gameVariables.value(420);
     };
	 ...
	 //alert(this._text.bitmap.textColor);
};
