...
Game_Interpreter.prototype.setChronoInterpreter = function(command, args) {
	...
	if (command === "tool_hud_visible")  {
		...
		$gameSystem._toolHudVisible[8] = value;
		$gameSystem._toolHudVisible[9] = value;
		$gameSystem._toolHudVisible[10] = value;
	};
};
...
ToolHud.prototype.setItemID = function() {
	if (this._index === 0) {
	    var toolID = $gameSystem._toolActorMode ? this._actor._toolItemId2 : $gameParty.tool_id();
		this._itemID = toolID;
...
ToolHud.prototype.getItems = function() {
	...
	if (this._index === 2) {
		return $dataSkills[$gameVariables.value(381)];
	};
	if (this._index === 3) {
		return $dataSkills[$gameVariables.value(382)];
	};
   	if (this._index === 4) {
		return $dataSkills[$gameVariables.value(383)];
	};
		if (this._index === 5) {
		return $dataSkills[$gameVariables.value(384)];
	};
		if (this._index === 6) {
		return $dataSkills[$gameVariables.value(385)];
	};
		if (this._index === 7) {
		return $dataSkills[$gameVariables.value(386)];
	};
		if (this._index === 8) {
		return $dataSkills[$gameVariables.value(387)];
	};
		if (this._index === 9) {
		return $dataSkills[$gameVariables.value(388)];
	};
		if (this._index === 10) {
		return $dataSkills[$gameVariables.value(389)];
	};
	return null;
};
...
ToolHud.prototype.toolEvent = function() {
	...
	if (!this._item.toolID) {return $gameMap.tool(1)};
...
ToolHud.prototype.refreshCostItem = function() {
	if (this._costItem.item) {
		this._costItem.itemNumber = $gameParty.numItems(this._item);
	...
	//名称显示
	if (this._index == 2)this._cost.bitmap.drawText("1/J",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 3)this._cost.bitmap.drawText("2/K",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 4)this._cost.bitmap.drawText("3/L",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 5)this._cost.bitmap.drawText("4/U",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 6)this._cost.bitmap.drawText("5/I",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 7)this._cost.bitmap.drawText("6/O",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 8)this._cost.bitmap.drawText("7/P",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 9)this._cost.bitmap.drawText("8",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 10)this._cost.bitmap.drawText("9",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 0)this._cost.bitmap.drawText("Q",0,25,this._cost.width,this._cost.height,"center");
	else if (this._index == 1)this._cost.bitmap.drawText("E",0,25,this._cost.width,this._cost.height,"center");
	else this._cost.bitmap.drawText(number,0,25,this._cost.width,this._cost.height,"center");
	
	//this._cost.bitmap.drawText(this._item.name,0,-40,this._cost.width,this._cost.height+50,"center");
	if (this._index >= 2 && this._item.repeats && this._item.repeats > 0)
	this._cost.bitmap.drawText('('+this._item.repeats+')',0,-20,this._cost.width,this._cost.height,"center");
	else if((this._index == 0||this._index == 1) && number>1)this._cost.bitmap.drawText(this._item.name+"("+number+")",0,-20,this._cost.width,this._cost.height,"center");
	else this._cost.bitmap.drawText(this._item.name,0,-20,this._cost.width,this._cost.height,"center");
};
...
ToolHud.prototype.needRefreshCost = function() {
	...
	//if (this._item.repeats > 1) {return true};
    return true;
};
...
ToolHud.prototype.getBitmap = function() {
	...
	if (this._index === 2) {return ImageManager.loadRas("Tool_Skill")};//1
	if (this._index === 3) {return ImageManager.loadRas("Tool_Skill")};//2
	if (this._index === 4) {return ImageManager.loadRas("Tool_Skill")};//3
	if (this._index === 5) {return ImageManager.loadRas("Tool_Skill")};//4
	if (this._index === 6) {return ImageManager.loadRas("Tool_Skill")};//5
	if (this._index === 7) {return ImageManager.loadRas("Tool_Skill")};//6
	if (this._index === 8) {return ImageManager.loadRas("Tool_Skill")};//7
	if (this._index === 9) {return ImageManager.loadRas("Tool_Skill")};//8
	if (this._index === 10) {return ImageManager.loadRas("Tool_Skill")};//9
	return null;
};
...
ToolHud.prototype.getPosition = function(type) {
	...
	if (this._index === 0) {
		...
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*1);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 4) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*2);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 5) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*3);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 6) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*4);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 7) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*5);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 8) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*6);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 9) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*7);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }else if (this._index === 10) {
		if (type === 0) {
			return Number(Moghunter.toolHud_WeaponX+my*8);
		} else {
			return Number(Moghunter.toolHud_WeaponY);
		};
    }
...
ToolHud.prototype.createCost = function() {
     this._cost = new Sprite(new Bitmap(62,62));//创造画布
...
ToolHud.prototype.refreshHud = function() {
	 ...
	 }else if (this._index>=2){this.refreshCost();}
...
ToolHud.prototype.needHide = function(start) {
	...
	if (!$gameSystem._toolHudVisible[this._index]) {
         return true
        };
...
ToolHud.prototype.update = function() {
    ...
    if (this._enabled && this._iconImg.isReady()) {
    	this.updateSprites();
    	};
};