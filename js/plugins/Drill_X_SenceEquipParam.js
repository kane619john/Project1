...
/*
	...
	Window_EquipStatus.prototype.drawCurrentParam = function(x, y, paramId) {
		...
		if(paramId <= 7){
		    ...
		    if(paramId - 8 == 0)data = (this._actor.hit*100).toFixed(1)+"%";//命中
			if(paramId - 8 == 1)data = (this._actor.eva*100).toFixed(1)+"%";//闪避
			if(paramId - 8 == 2)data = (this._actor.cri*100).toFixed(1)+"%";//暴击
			if(paramId==15)data=parseInt(data/5);
