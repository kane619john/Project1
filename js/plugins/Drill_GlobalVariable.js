...
DataManager.saveGlobalInfo2 = function(info) {	//第0个存档为全局存档
	if(!info[0]){info[0] = []};
...
DataManager.forceSaveGlobalInfo = function() {		//强制存储（任何改变的全局变量的地方都需要调用该方法）
	...
	this.saveGlobalInfo2(globalInfo);
};
DataManager.saveGlobalInfo2 = function(info) {
    StorageManager.save(0, JsonEx.stringify(info));
};
//=============================================================================
// ** 读取地图赋值
//=============================================================================
